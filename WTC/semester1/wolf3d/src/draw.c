...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/21 10:48:06 by jlangman          #+#    #+#             */
/*   Updated: 2016/11/21 10:53:25 by jlangman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			color(t_env *te, t_rgb *color)
{
	if (te->player.side == 0)
	{
		if (te->player.x_step < 0)
			set_color(color, 120, 0, 0);
		else
			set_color(color, 0, 120, 0);
	}
	else if (te->player.y_step < 0)
		set_color(color, 140, 140, 140);
	else
		set_color(color, 100, 0, 100);
}
